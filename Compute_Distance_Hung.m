...
Proposal_ClustersforHung='..Data/DatasetName/DatasetName_ProposalsClusters';
Similarity_Hung_Path='..Data/DatasetName/DatasetName_Similarity_Hung_6';
...
for iAction=1:length(All_Actions)
    ...
    nFiles=length(All_Files);
     ...
     All_Traj=cell(1,Num_Top_Prop*nFiles);
     All_MBH=cell(1,Num_Top_Prop*nFiles);
     All_HOG=cell(1,Num_Top_Prop*nFiles);
     All_HOF=cell(1,Num_Top_Prop*nFiles);
   ...
   cc=0;
     for iFile=1:nFiles
         ...
         load(Prop_Clus)
          ...
          if size(Tublets_raw_cluster_6,2)<Num_Top_Prop
              
              for mm=1:(Num_Top_Prop-size(Tublets_raw_cluster_6,2))
